...
namespace MvcAppAws_Daniel_delaCruz.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID_Alumno,NombreCompleto,Matricula,Carrera,EmpresaAsignada,FechaInicio,FechaFin,Estado")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_Alumno,NombreCompleto,Matricula,Carrera,EmpresaAsignada,FechaInicio,FechaFin,Estado")] Alumno alumno)
        {
